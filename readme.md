...
이것은 웹 브라우저를 이용하여 간단한 텍스트를 송출하는 도구입니다. 이 내용은 2.0-beta1 버전 기준으로 작성되었습니다.
...
- `0`~`9` 키 또는 `M`(=0), `J`(=1), `K`(=2), `L`(=3), `U`(=4), `I`(=5), `O`(=6), `7`, `8`, `9` 키를 눌러 숫자를 입력하고 `Enter` 키를 누르면 해당 페이지가 PVW로 올라옵니다.
